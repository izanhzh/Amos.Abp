...
- [Bulk Repository (Not yet perfect)](#bulk-repository-not-yet-perfect)
...
{
    public YourTempTableRepository(IDbContextProvider<IYourDbContext> dbContextProvider) : base(dbContextProvider)
    {
    }
}
```
...
# Bulk Repository (Not yet perfect)
