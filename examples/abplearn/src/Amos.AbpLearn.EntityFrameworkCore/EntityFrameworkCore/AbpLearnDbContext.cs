...
namespace Amos.AbpLearn.EntityFrameworkCore
{
    ...
    [ReplaceDbContext(typeof(IProductManagementDbContext))]
    [ReplaceDbContext(typeof(IOrderManagementDbContext))]
    [ConnectionStringName("Default")]
    public class AbpLearnDbContext :
        AbpDbContext<AbpLearnDbContext>,
        IIdentityDbContext,
        ITenantManagementDbContext,
        IProductManagementDbContext,
        IOrderManagementDbContext
    {
